...
import { createTask, selectTaskById, updateTask } from '@app/features/task-manager/taskSlice';
...
export const AddOrEditTask = ({ taskId, mode, isOpen, onClose }: AddOrEditTaskProps) => {
  const dispatch = useAppDispatch();
  const task = useAppSelector(state => selectTaskById(state, taskId));
  const taskLoading = useAppSelector(state => state.tasks.addOrEditTaskLoading);
  ...
  return (
    <Modal isOpen={isOpen} title={mode === 'add' ? 'Create Task' : 'Edit Task'} onClose={onClose}>
      <div className="add-or-edit-task">
        <form className="add-or-edit-task__form" onSubmit={formik.handleSubmit}>
          <div className="add-or-edit-task__form-group">
            ...
            <input
              className={`add-or-edit-task__form-input ${formik.touched.title && formik.errors.title ? 'error' : ''}`}
              id="title"
              name="title"
              type="text"
          ...
          <div className="add-or-edit-task__form-group">
            <label className="add-or-edit-task__form-label" htmlFor="description">
              Description
            </label>
            <textarea
              id="description"
          ...
          <div className="add-or-edit-task__form-group">
            <button className="add-or-edit-task__form-submit" disabled={taskLoading} type="submit">
