export const DeleteIcon = () => {
  return (
    <svg height="24px" width="24px" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M12 13V18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path
